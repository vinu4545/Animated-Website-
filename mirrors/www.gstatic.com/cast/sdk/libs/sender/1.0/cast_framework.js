...
*/
    ...
    var h = this || self,
        ...
        m = function(a, b) {
            ...
            a.hc = function(d, e, f) {
                for (var g = Array(arguments.length - 2), p = 2; p < arguments.length; p++) g[p - 2] = arguments[p];
    ...
    var v = class {
        ...
        y = new v("WARNING", 900),
        z = new v("CONFIG", 700),
        A = [w, new v("SHOUT", 1200), x, y, new v("INFO", 800), z, new v("FINE", 500), new v("FINER", 400), new v("FINEST", 300), new v("ALL", 0)],
        B = null,
        fa = class {
            constructor() {
                this.ca = 0;
        ...
        E = function(a, b, c, d) {
            ...
            if (e) {
                ...
                if (0 < f.ca) {
                    var g = (f.Na + 1) % f.ca;
                    f.Na = g;
                    f.Sa ? (f = f.La[g], f.reset(b, c, a), a = f) : (f.Sa = g == f.ca - 1, a = f.La[g] = new ia(b, c, a))
                } else a = new ia(b, c, a);
                a.ea =
                    d;
                e.publish(a)
    ...
    var xa = function(a) {
        ...
        za = function(a) {
            a instanceof I || (a = "object" == typeof a && a.Eb ? a.Cb() : String(a), va.test(a) && (-1 != a.indexOf("&") && (a = a.replace(pa, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(qa, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(ra, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(sa, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(ta, "&#39;")), -1 != a.indexOf("\x00") && (a =
                a.replace(ua, "&#0;"))), a = ya(a));
            return a
        },
        ya = function(a) {
    ...
    */
    ...
    class Qa {
        ...
        get() {
            let a;
            0 < this.ka ? (this.ka--, a = this.ha, this.ha = a.next, a.next = null) : a = this.nb();
            return a
        }
        put(a) {
            this.Tb(a);
    ...
    var Ra, Sa = function() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == G().indexOf("Presto") && (a = function() {
            ...
            e = k(function(q) {
                if (("*" == p || q.origin == p) && q.data == g) this.port1.onmessage()
            }, this);
    ...
    class Ua {
        ...
        remove() {
            let a = null;
            this.R && (a = this.R, this.R = this.R.next, this.R || (this.na = null), a.next = null);
            return a
        }
    }
    ...
    var gb = function(a, b) {
            if (0 == a.l)
                if (a.G) {
                    var c = a.G;
                    if (c.A) {
                        for (var d = 0, e = null, f = null, g = c.A; g && (g.aa || (d++, g.F == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g);
                        e && (0 == c.l && 1 == d ? gb(c, b) : (f ? (d = f, d.next == c.I && (c.I = d), d.next = d.next.next) : hb(c), ib(c, e, 3, b)))
                    }
                    a.G = null
                } else O(a, 3, b)
        },
    ...
    var O = function(a, b, c) {
            if (0 == a.l) {
                ...
                g || (a.ab = c, a.l = b, a.G = null, jb(a), 3 != b || c instanceof P || mb(a, c))
            }
        },
    ...
    class rb extends S {
        ...
        stop() {
            this.H && (h.clearTimeout(this.H), this.H = null, this.P = !1, this.ba = null)
        }
        pause() {
            this.X++
        }
    ...
    const wb = class {
        ...
        Ea() {
            this.j && (this.v++, this.g.isPaused = !this.g.isPaused, this.g.isPaused ? this.j.pause(null, this.M, this.L) : this.j.play(null, this.M, this.L))
        }
        stop() {
        ...
        Ca() {
            this.h && (this.v++, this.g.isMuted = !this.g.isMuted, this.h.setReceiverMuted(this.g.isMuted, this.M, this.L))
        }
        Ja() {
            this.fc.tb()
        }
        rb() {
            this.h && (this.v++, this.h.setReceiverVolumeLevel(this.g.volumeLevel, this.M, this.L))
        }
        Mb() {
            this.v--;
            this.D()
        ...
        Ob() {
            this.j && ("function" === typeof this.j.getEstimatedBreakTime && (this.g.currentBreakTime = this.j.getEstimatedBreakTime()), "function" === typeof this.j.getEstimatedBreakClipTime &&
                (this.g.currentBreakClipTime = this.j.getEstimatedBreakClipTime()), "function" === typeof this.j.getEstimatedLiveSeekableRange && (this.g.liveSeekableRange = this.j.getEstimatedLiveSeekableRange()), this.g.currentTime = this.j.getEstimatedTime(), this.C = setTimeout(this.Xa, 1E3))
        }
        D(a) {
            if (!(0 < this.v))
                if (this.h) {
                    ...
                    if (this.j) {
                        ...
                        if (T(a)) {
                            ...
                            c && d ? (c = c.breakClipIds.indexOf(d.id), c = 0 > c ? 0 : c) : c = 0;
                            ...
                            this.g.currentBreakClipTime =
                                "function" === typeof b.getEstimatedBreakClipTime ? b.getEstimatedBreakClipTime() : a.currentBreakClipTime;
                        ...
                        this.C && (clearTimeout(this.C), this.C = null);
                        b.playerState == chrome.cast.media.PlayerState.PLAYING && (this.C =
                            setTimeout(this.Xa, 1E3))
                    } else this.Z(null)
                } else this.g.displayName = "", this.g.displayStatus = "", this.Z(null)
        }
        Z(a) {
            a ? (this.g.duration = a.duration || 0, a.metadata && a.metadata.title && (this.g.displayStatus = a.metadata.title)) : (this.g.isMediaLoaded = !1, this.g.canPause = !1, this.g.canSeek = !1, this.g.currentTime = 0, this.g.duration = 0, this.g.isPlayingBreak = !1, this.g.numberBreakClips = 0, this.g.currentBreakClipNumber = 0, this.g.currentBreakTime = void 0, this.g.currentBreakClipTime = void 0, this.g.breakId = void 0, this.g.breakClipId =
                void 0, this.g.whenSkippable = void 0)
        }
        Ia(a) {
    ...
    var Mb = function(a) {
        ...
        Nb = function(a, b) {
            a.Ya = b;
            !b.volume || a.o && a.o.muted == b.volume.muted && a.o.level == b.volume.level || (a.o = b.volume, a.m.dispatchEvent(new Jb(a.o.level, a.o.muted)));
            a.ia != b.isActiveInput && (a.ia = b.isActiveInput, b = a.ia, a.m.dispatchEvent(new Db(null == b ? -1 : b ? 1 : 0)))
        },
        V = class {
            constructor(a, b) {
                this.m = new Lb;
            ...
            Pa(a) {
                "SESSION_ENDED" != this.l && (a ? this.i.stop(() => {}, () => {}) : this.i.leave(() => {}, () => {}))
            }
            setVolume(a) {
                const b = R(),
            ...
            sendMessage(a, b) {
                ...
                this.i.sendMessage(a,
                    b, () => c.resolve(), e => c.reject(e.code));
                return d
            }
    ...
    var Qb = function(a) {
            if (!a.s || !a.s.receiverApplicationId) throw Error("Missing application id in cast options");
        ...
        X = function(a, b, c) {
            b == a.u ? "SESSION_START_FAILED" == b && a.m.dispatchEvent(new Ob(a.h, a.u, c)) : (a.u = b, a.h && (a.h.l = a.u), a.m.dispatchEvent(new Ob(a.h,
                a.u, c)), Rb(a))
        },
        Y = class {
            constructor() {
            ...
            requestSession() {
                if (!this.Aa) throw Error("Cannot start session before cast options are provided");
                const a = R(),
            ...
            Vb(a) {
                this.s ? (this.s.credentialsData = a, Qb(this)) : W && E(W, y, "setLaunchCredentialsData was ignored because it was called before setOptions.")
            }
            Sb(a) {
                ...
                if (this.h) switch (this.h.i.status) {
                    ...
                    case chrome.cast.SessionStatus.CONNECTED:
                        var a = this.h,
                            ...
                            c = a.i,
                            d;
                        if (d = b.applicationId == c.appId && b.name == c.displayName) a: if (d = b.namespaces, b = b.Da(c.namespaces || []), ba(d) && ba(b) && d.length == b.length) {
                            c = d.length;
                            for (let e = 0; e < c; e++)
                                if (d[e] !== b[e]) {
                                    d = !1;
                        ...
                        Nb(a, a.i.receiver);
                        a.Y != a.i.statusText && (a.Y = a.i.statusText, a.m.dispatchEvent(new Gb(a.Y)));
                        break;
                    default:
                        W && E(W, y, "Unknown session status " + this.h.i.status)
                } else W &&
                    E(W, y, "Received session update event without known session")
            }
        };
    ...
    var Sb = function() {
        ...
        Vb = function(a) {
            ...
            else switch (a.J.style.display = a.ob, a.l) {
                case "NOT_CONNECTED":
        ...
        Wb = function(a, b) {
            ...
            a.Wa = a.Nb.bind(a);
            a.oa = [];
            for (let c = 0; 3 > c; c++) a.oa.push(b.querySelector("#cast_caf_icon_arch" +
                c));
    ...
    customElements.define ? (customElements.define("google-cast-button", $b, {
        extends: "button"
    }), customElements.define("google-cast-launcher", Zb)) : ("complete" !== document.readyState ? window.addEventListener("load", cc) : cc(), bc());
            ...
            Ub(a) {
                switch (a.sessionState) {
                    ...
                    case "SESSION_RESUMED":
                        ...
                        b && (vb(this, b), a.session.addEventListener("mediasession", this.Va.bind(this)))
                }
            }
            D(a) {
                const b = Y.K().h;
                ...
                a ? (this.g.queueData = a.queueData, this.g.videoInfo = a.videoInfo,
                    this.g.liveSeekableRange = "function" === typeof a.getEstimatedLiveSeekableRange ? a.getEstimatedLiveSeekableRange() : a.liveSeekableRange) : (this.g.queueData = void 0, this.g.videoInfo = void 0, this.g.liveSeekableRange = void 0)
            }
            Z(a) {
                super.Z(a);
